...
export default function IndProjectDetail({ indproject, onBack }: IndProjectDetailProps) {
  const IconComponent = iconMap[indproject.icon as keyof typeof iconMap] || Code2;
        ...
        <div className="container mx-auto px-3 py-2 sm:px-4 sm:py-3">
          <div className="flex flex-wrap items-start gap-x-2 gap-y-1">
            ...
            <div className="flex items-start gap-2 w-full sm:w-auto">
              <div className={`p-1 rounded-lg bg-gradient-to-r ${indproject.gradient} bg-opacity-20 shadow-inner`}>
          ...
          <CardHeader>
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
              <div className="flex-1">
                ...
                <div className={`flex-shrink-0 p-3 rounded-lg bg-gradient-to-r ${indproject.gradient} bg-opacity-20 shadow-inner w-fit h-fit`}>
